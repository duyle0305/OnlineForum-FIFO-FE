...
const Transactions: FC = () => {
    ...
    // const [selectedType, setSelectedType] = useState<string | undefined>(undefined); // Add selectedType state
    const [params, setParams] = useState<FilterTransactionParams>({
        viewTransaction: false,
        dailyPoint: false,
        bonusPoint: false,
    ...
    //     return matchesStatus && matchesType; // Combine both filters
    // });
    ...
    return (
        <div css={styles}>
            <Flex justify="space-between" className="transaction-header">
                <Typography.Text style={{ fontSize: 20, fontWeight: 500 }}>Last Transaction</Typography.Text>
                <Flex gap={16}>
                    <Space>
                        <Typography.Text>Type:</Typography.Text>
                        <Select
